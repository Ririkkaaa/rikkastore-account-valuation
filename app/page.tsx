...
export default function RikkaPricingApp() {
  ...
  // --- ADMIN SETTINGS ---
  const [aWeight, setAWeight] = useState<number>(0.18); 
  const [cBase, setCBase] = useState<number>(1.5); 
  const [wBase, setWBase] = useState<number>(1.5); 
  const [tComp, setTComp] = useState<number>(1.3); 
  const [floorPrice, setFloorPrice] = useState<number>(4.0); 
